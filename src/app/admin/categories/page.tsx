...
export default function AdminCategoriesPage() {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast(`Category "${deleteCategory.name}" removed.`);
      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-evo-red hover:bg-evo-red-hover text-white text-xs font-bold shadow-evo-button transition-all hover:scale-[1.02] w-full sm:w-auto"
