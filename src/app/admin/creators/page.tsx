...
export default function AdminCreatorsPage() {
  ...
  const handleToggleSuspend = async (creator: AdminCreator) => {
    ...
    try {
      ...
      toast(`Creator ${creator.name} has been ${newStatus.toLowerCase()}.`);
    } catch (e) {
      toast(e instanceof Error ? e.message : "Failed to update creator", "error");
    }
  };
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50/80 border-b border-gray-100 text-[11px] font-bold uppercase tracking-wider text-gray-500">
                    <th className="py-4 px-6 min-w-[220px]">Creator / Studio</th>
                    <th className="py-4 px-6 min-w-[150px]">Hub</th>
                    <th className="py-4 px-6 min-w-[160px]">Email</th>
