...
export default function AdminUsersPage() {
  ...
  const handleToggleSuspend = async (user: AdminUser) => {
    ...
    try {
      ...
      toast(`User ${user.name} has been ${newStatus.toLowerCase()}.`);
    } catch (e) {
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50/80 border-b border-gray-100 text-[11px] font-bold uppercase tracking-wider text-gray-500">
                    <th className="py-4 px-6 min-w-[220px]">User Profile</th>
                    <th className="py-4 px-6 min-w-[110px]">Role</th>
                    <th className="py-4 px-6 min-w-[100px]">Status</th>
                    <th className="py-4 px-6 min-w-[110px]">Email Verified</th>
                    <th className="py-4 px-6 min-w-[110px]">Joined</th>
