      ...
      <form onSubmit={handleSubmit} className="flex items-center gap-3 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-white border border-gray-300 rounded-full pl-12 pr-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:border-gray-400 focus:ring-2 focus:ring-gray-200 focus:outline-none"
          />
        </div>
        <button
          type="submit"
