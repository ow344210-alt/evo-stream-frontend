...
export function AuthModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-md max-h-[90vh] bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-2xl p-4 sm:p-6 lg:p-8 flex flex-col">
        {/* Close Button */}
        <button
          onClick={onClose}
