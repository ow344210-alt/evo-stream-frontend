        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-10 pb-8 lg:pb-12 border-b border-gray-800/80">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400">
              <li><Link href="/discover" className="hover:text-white transition-colors">Trending Videos</Link></li>
              <li><Link href="/discover" className="hover:text-white transition-colors">Latest Uploads</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400">
              ...
              <li><Link href="/creator" className="hover:text-white transition-colors">Ad-Powered Monetization</Link></li>
              <li><Link href="/creator" className="hover:text-white transition-colors">HLS Cloud Transcoding</Link></li>
              <li><Link href="/creator" className="hover:text-white transition-colors">Partner Program</Link></li>
              <li><Link href="/creator" className="hover:text-white transition-colors">Hub Verification</Link></li>
            </ul>
          </div>
