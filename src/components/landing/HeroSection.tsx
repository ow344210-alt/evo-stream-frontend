    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 mb-10 w-full sm:w-auto">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-evo-red hover:bg-evo-red-hover text-white text-base font-semibold px-6 sm:px-7 py-3 sm:py-3.5 rounded-full shadow-evo-button hover:shadow-evo-button-hover transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
              ...
              <button
                onClick={onExplore}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-gray-800 text-base font-semibold px-5 sm:px-6 py-3 sm:py-3.5 rounded-full border border-gray-200 hover:border-gray-300 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          ...
          <div className="lg:col-span-6 flex justify-center lg:justify-end relative mt-6 lg:mt-0">
            <div className="relative w-full max-w-[340px] sm:max-w-[420px] lg:max-w-[580px]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {HERO_DATA.stats.map((stat, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="text-lg sm:text-xl sm:text-2xl font-extrabold text-gray-950 tracking-tight truncate">
                      {stat.number}
                    </div>
