                ...
                <div className="relative">
                  ...
                  {userMenuOpen && (
                    <>
                      ...
                      <div
                        role="menu"
                        className="absolute right-0 mt-2 w-56 sm:w-60 max-w-[calc(100vw-2rem)] bg-white border border-gray-200 rounded-2xl shadow-xl py-2 z-20"
                      >
                        {user?.role === "ADMIN" && (
                          <>
                            <Link
                              ...
                              onClick={() => setUserMenuOpen(false)}
                              role="menuitem"
                              id="nav-user-admin-hub"
                              className="flex items-center gap-3 px-4 py-2.5 text-sm font-bold text-evo-red bg-evo-red/5 hover:bg-evo-red/10 transition-colors"
                            >
                              <Tv className="w-4 h-4 text-evo-red shrink-0" />
                              <span className="truncate">Admin Control Hub</span>
                            </Link>
                ...
                <>
                  {user?.role === "ADMIN" && (
                    <Link
                      ...
                      id="nav-mobile-admin-hub"
                      className="w-full flex items-center justify-center gap-2 py-2.5 text-sm font-bold text-white bg-evo-red rounded-xl shadow-evo-button"
                    >
