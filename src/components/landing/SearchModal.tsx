          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex-1 min-w-0">
              ...
              <input
                ...
                className="w-full min-w-0 h-[52px] pl-11 pr-4 rounded-full bg-gray-100/80 border border-gray-200 text-gray-900 placeholder-gray-400 text-base sm:text-lg font-medium focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-200 focus:bg-white transition-colors"
              />
              {query && (
                <button
                  type="button"
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-semibold text-gray-500 hover:text-gray-900 px-2.5 py-1 rounded-full hover:bg-gray-200/70 shrink-0"
                >
                  Clear
                </button>
              )}
